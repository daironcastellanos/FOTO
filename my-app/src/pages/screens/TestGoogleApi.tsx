...
const TestGoogleApi: React.FC = () => {
  ...
  const getNearbyUsers = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/nearby_users/${fireID}`
      );
      if (
        response.ok &&
  ...
  const getRandomPhoto = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/random_pic/get`);
  ...
  const updateBio = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/update_bio`,
        {
          method: "POST",
          headers: {
  ...
  const search_username = async () => {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/username/${username}/get`
      );
      if (!response.ok) {
  ...
  async function addPhotoToSaved() {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/savePhoto`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function followUser() {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/follow`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function removePhotoFromSaved() {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/removePhoto`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function unfollowUser() {
    ...
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/unfollow`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function updateUserLocation() {
    ...
    navigator.geolocation.getCurrentPosition(async (position) => {
      ...
      try {
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/users/${fireID}/updateLocation`,
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
